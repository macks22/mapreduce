 ...
 */
public class PatentCitingCounter extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, PatentCitingCounter.class.getSimpleName());
        job.setJarByClass(PatentCitingCounter.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new Configuration(), new PatentCitingCounter(), args);
